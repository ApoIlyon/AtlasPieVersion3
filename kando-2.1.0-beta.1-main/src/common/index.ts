...
export type ShowMenuOptions = {
  ...
  /**
   * The accelerator string of the shortcut that opened the menu. If provided, the menu
   * will automatically close once all keys or buttons of this shortcut are released.
   */
  readonly trigger?: string;
