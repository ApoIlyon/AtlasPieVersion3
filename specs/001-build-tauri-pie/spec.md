...
- **FR-012a**: Любая новая пользовательская функциональность и UI-тексты ДОЛЖНЫ сопровождаться локализационными ключами и переводами для всех поддерживаемых языков до завершения задачи.
