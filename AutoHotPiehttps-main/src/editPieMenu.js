    ...
    pieMenuDisplay:{
        ...
        draw:{
            ...
            pieCircle:function(pieCircleElement, position){
                ...
                ctx.strokeStyle = rgbaArrayToCssColor(selectedPieMenu.backgroundColor)                
                ctx.beginPath();
                ...
                if(editPieMenu.selectedPieKey.activationMode.escapeRadius.enable){
                    ctx.lineWidth = 2                  
                    ctx.strokeStyle = rgbaArrayToCssColor([255,0,0,0])                
                    // ctx.strokeStyle = rgbaArrayToCssColor(selectedPieMenu.backgroundColor)                
                    ctx.beginPath();
                ...
                if (pieCircleElement.isSelected == true){                    
                    ...
                    ctx.strokeStyle = rgbaArrayToCssColor(selectedPieMenu.selectionColor);
            ...
            label: function(labelText, labelIcon, sliceHotkey, labelPos, labelAnchor=[0,0], element=null){     
                ...
                if(isSelected){
                    ctx.fillStyle = rgbaArrayToCssColor(selectedPieMenu.selectionColor);            
                    // ctx.strokeStyle = rgbaArrayToCssColor(selectedPieMenu.selectionColor);                    
                    ctx.strokeStyle = 'rgba(1,1,1,0)';                    
                }else{
                    ctx.fillStyle = rgbaArrayToCssColor(selectedPieMenu.backgroundColor);            
                    // ctx.strokeStyle = rgbaArrayToCssColor(AutoHotPieSettings.global.globalAppearance.safetyStrokeColor);
                    ctx.strokeStyle = 'rgba(1,1,1,0)';                    
                }      
                ctx.lineWidth = 1;    
                ...
                for (let k in labelElements){
                    ...
                    if (labelElement.type == "labelText"){
                        if(isSelected){
                            ...
                            ctx.fillStyle = rgbaArrayToCssColor(selectedPieMenu.fontColor);
    ...
    appearanceSettings:{
        initialize:function(){
            ...
            this.mainMenu.selectionColorInput.onInput = throttle(function(){                                  
                    editPieMenu.selectedPieMenu.selectionColor = cssColorToRgba(this.toRGBAString());
                    editPieMenu.pieMenuDisplay.refresh();
                },colorRefreshTime);
            ...
            this.mainMenu.backgroundColorInput.onInput = throttle(function(){    
                editPieMenu.selectedPieKey.pieMenus.forEach((pieMenu) => {pieMenu.backgroundColor = cssColorToRgba(this.toRGBAString())})
                editPieMenu.pieMenuDisplay.refresh();
            },colorRefreshTime);
            ...
            this.mainMenu.fontColorInput.onInput = throttle(function(){                                  
                editPieMenu.selectedPieKey.pieMenus.forEach((pieMenu) => {pieMenu.fontColor = cssColorToRgba(this.toRGBAString())})
                editPieMenu.pieMenuDisplay.refresh();
            },colorRefreshTime);
        ...
        loadSelectedPieKey:function(){
            ...
            if(editPieMenu.selectedPieKey.pieMenus.indexOf(editPieMenu.selectedPieMenu) == 0){                
                ...
                this.mainMenu.selectionColorInput.processValueInput(rgbaArrayToCssColor(selectedPieMenu.selectionColor))
                
                this.mainMenu.backgroundColorInput.processValueInput(rgbaArrayToCssColor(selectedPieMenu.backgroundColor))                 
                this.mainMenu.fontColorInput.processValueInput(rgbaArrayToCssColor(selectedPieMenu.fontColor))                 
                ...
                this.subMenu.selectionColorInput.processValueInput(rgbaArrayToCssColor(selectedPieMenu.selectionColor));
...
function handleColorInput(event){  
    ...
    return cssColorToRgba(colorControl.value);
}
