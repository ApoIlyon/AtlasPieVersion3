...
var profileManagement = {
    ...
    initialize:function(){
        ...
        this.hoverActivation.initialize();
    ...
    updateUIControls: function(){   
        ...
        this.hoverActivation.updateUIControls();
    ...
    hoverActivation:{
        ...
        container: null,
        initialize:function(){
            this.checkbox = document.getElementById("hover-activation-checkbox");
            this.container = $('#hover-activation-checkbox-div');
            if (this.checkbox){
                this.checkbox.addEventListener('change', () => {
                    profileManagement.selectedProfile.hoverActivation = this.checkbox.checked;
                });
            }
        },
        updateUIControls:function(){
            ...
            this.checkbox.checked = !!selectedProfile.hoverActivation;
        }
    },
        ...
        updateUIControls:function(){
            ...
            profileManagement.selectedProfile.pieKeys.forEach(function(pieKey,index){
                ...
                function createPieKeyRow(rgbArrayColor,pieHotKey,pieKeyName,globalState){
                    ...
                    // cell2.innerHTML = '<input type="button" data-jscolor value="' + rgbaArrayToCssColor(rgbArrayColor) + '" data-bs-toggle="tooltip" style="width: 55px;height: 30px;margin-top: 3px;" title="Color of pie menu." name="pie-menu-color-control" />'
                    ...
                    newJSColor.onChange = function(){
                        profileManagement.selectedProfile.pieKeys[index].pieMenus[0].selectionColor = cssColorToRgba(this.toRGBAString());                        
                    };                  
                    newJSColor.processValueInput(rgbaArrayToCssColor(rgbArrayColor));               
        ...
        createOverviewTableListeners: function(){
            this.overviewTable.addEventListener("onChange", function(event){ 
                ...
                if (target && target.name == "color"){   
                    // console.log(ran)             
                    profileManagement.selectedProfile.pieKeys[pieKeyIndex].pieMenus[0].selectionColor = cssColorToRgba(target.value);
                }
            });           
