var newPieMenu = {
    ...
    initialize: function(){        
        ...
        this.selectionColorInput.onChange = function(){
            newPieMenu.newPieKeyObj.pieMenus[0].selectionColor = cssColorToRgba(this.toRGBAString());                        
        };
        this.backgroundColorInput.onChange = function(){            
            newPieMenu.newPieKeyObj.pieMenus.forEach((pieMenu) => {
                pieMenu.backgroundColor = cssColorToRgba(this.toRGBAString());
            });                       
        };
    ...
    refresh:function(){
        ...
        this.selectionColorInput.processValueInput(rgbaArrayToCssColor(np.newPieKeyObj.pieMenus[0].selectionColor));
        this.backgroundColorInput.processValueInput(rgbaArrayToCssColor(np.newPieKeyObj.pieMenus[0].backgroundColor));
    }
}
