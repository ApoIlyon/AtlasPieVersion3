use crate::commands::{AppState, AppError, SystemState, HotkeyState, ProfileRouterState};
...
use crate::services::{
    ...
    profile_router::{self, ProfileRouterState as ProfileRouterServiceState},
    storage_guard,
...
use crate::commands::update_state::UpdatesState;
use std::collections::HashMap;
use std::sync::{Arc, Mutex};
use tauri::{App, AppHandle, Emitter, Manager, Runtime};
use tokio::sync::broadcast::error::RecvError;

pub fn init_app<R: Runtime>(app: &mut App<R>) -> anyhow::Result<()> {
    ...
    app.manage(ProfileRouterServiceState::default());
