...
const FALLBACK_STRINGS: Record<string, string> = {
  ...
  'profilesDashboard.currentlyActive': 'Currently Active',
  'profilesDashboard.deleteProfile': 'Delete Profile',
  'profilesDashboard.disabled': 'Disabled',
  'profilesDashboard.emptyBody': 'Create your first profile to start building pie menus.',
  'profilesDashboard.emptyCreateButton': 'Create Profile',
  'profilesDashboard.emptyTitle': 'No profiles yet',
  'profilesDashboard.enabled': 'Enabled',
  'profilesDashboard.hotkeyLabel': 'Hotkey',
  'profilesDashboard.metricMenus': 'Menus',
  'profilesDashboard.metricNested': 'Nested',
  'profilesDashboard.metricSlices': 'Slices',
  'profilesDashboard.newProfileButton': 'New Profile',
  'profilesDashboard.noRules': 'No rules',
  'profilesDashboard.openEditor': 'Open Editor',
  'profilesDashboard.ruleMultiple': '{count} rules',
  'profilesDashboard.ruleSingle': '{count} rule',
  'profilesDashboard.sectionDescription': 'Manage your pie menu profiles',
  'profilesDashboard.sectionLabel': 'Profiles',
  'profilesDashboard.sectionTitle': 'Your Profiles',
  'profilesDashboard.setActive': 'Set Active',
  'profilesDashboard.statusActive': 'Active',
  'profilesDashboard.statusReady': 'Ready',
  ...
  'settings.importExport.selectProfiles': 'Select profiles to export',
  'settings.importExport.selectAll': 'Select all',
  'settings.importExport.deselectAll': 'Deselect all',
  'settings.importExport.selected': 'selected',
  'settings.importExport.noProfilesSelected': 'Please select at least one profile to export.',
  'settings.importExport.cancel': 'Cancel',
  'settings.importExport.export': 'Export',
  'settings.importExport.size': 'Size',
  'settings.importExport.profiles': 'Profiles',
  'settings.importExport.menus': 'menus',
  'settings.importExport.actions': 'actions',
  'settings.importExport.noProfiles': 'No profiles available',
  ...
  'settings.autostart.launcherPath': 'Autostart launcher path',
  'settings.autostart.provider.label': 'Managed by',
  'settings.autostart.provider.systemd': 'systemd user service',
  'settings.autostart.provider.xdg_desktop': 'XDG desktop entry',
  'settings.autostart.provider.plugin': 'Platform autostart plugin',
  'settings.autostart.provider.windows_startup': 'Windows Startup folder',
  'settings.autostart.provider.macos_launch_agent': 'macOS login item',
  'settings.autostart.provider.unsupported': 'Autostart unsupported',
  'settings.autostart.reason.plugin_missing': 'Autostart plugin is unavailable on this platform.',
  'settings.autostart.reason.plugin_disabled': 'Autostart is disabled by platform plugin settings.',
  'settings.autostart.reason.plugin_error': 'Failed to query autostart plugin status.',
  'settings.autostart.reason.shortcut_missing': 'Startup shortcut is missing. Enable autostart to recreate it.',
  'settings.autostart.reason.startup_dir_error': 'Unable to access the Startup folder. Check permissions.',
  'settings.autostart.reason.linux_no_provider': 'Autostart unavailable. Install systemd or allow XDG autostart.',
  'settings.autostart.reason.linux_detection_error': 'Failed to detect Linux autostart providers.',
  'settings.autostart.reason.entry_missing': 'Desktop entry missing. Enable autostart to create it.',
  'settings.autostart.reason.unit_missing': 'Systemd unit missing. Enable autostart to register it.',
  'settings.autostart.reason.unit_disabled': 'Systemd unit disabled. Enable autostart to activate it.',
  'settings.autostart.reason.web_environment': 'Autostart is not available in the web preview.',
  'settings.autostart.reason.unexpected_error': 'Unexpected autostart error. Try again.',
  ...
  'linuxFallback.details.lastActionMessage': 'Last action message',
  'linuxFallback.details.lastActionTitle': 'Last action',
  'linuxFallback.details.statusLine': 'Status: {status} · {time}',
  'linuxFallback.details.lastUpdated': 'Last updated',
  'linuxFallback.autostart.statusUnknown': 'Autostart status unavailable',
  'linuxFallback.autostart.refresh': 'Refresh autostart',
  'linuxFallback.autostart.provider': 'Autostart provider: {provider}',
  ...
  'settings.updates.newAvailable': 'New version available',
  'settings.updates.advanced': 'Advanced options',
  'settings.updates.updateChannel': 'Update channel',
  'settings.updates.channel.stable': 'Stable',
  'settings.updates.channel.beta': 'Beta',
  'settings.updates.autoCheck': 'Automatic update checks are enabled',
  'settings.updates.checkInterval': 'Checks every {hours} hours',
